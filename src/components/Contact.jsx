...
export const Contact = () => {
  ...
  return (
    <>
      <Box sx={{ backgroundColor: "#04273F", height: "auto" }}>
        ...
        >
          ...
          >
            ...
            >
              We’d love to talk about your content challenges! Let’s explore how
              we can remove obstacles from your content lifecycle and help your
              team manage and scale operations more effectively.
            </Typography>
            <Typography
              sx={{
     ...
     <Box sx={{ maxWidth: '100%', mx: 'auto', p: 3, backgroundColor:"#F3F7FB" }}>
      <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Typography variant="body2" sx={{ mt: -2,ml:"100px" }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 1,ml:"100px", }}>
          <Button 
            type="submit" 
            variant="contained" 
            sx={{ 
